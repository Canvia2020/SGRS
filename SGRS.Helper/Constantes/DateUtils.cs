...
namespace SGRS.Helper.Constantes
{
    public class DateUtils
    {
        ...
        /// <summary>
        /// Función que convierte la fecha ingresada(dd/MM/yyyy) en datetime
        /// </summary>
        /// <returns>Datetime</returns>
        public static DateTime getDateTimeddMMyyyy(String fecha)
        {
            try
            {
                //return DateTime.ParseExact(fecha, new string[] { "MM.dd.yyyy", "MM-dd-yyyy", "MM/dd/yyyy", "M/dd/yyyy", "M/d/yyyy", "M/d/yy" },
        ...
        /// <summary>
        /// Función que convierte un Datetime en un Strign formateado dd/MM/yyyy
        /// </summary>
        /// <returns>Datetime</returns>
        public static String getDateTimeddMMyyyyStr(DateTime fecha)
        {
            try
            {
