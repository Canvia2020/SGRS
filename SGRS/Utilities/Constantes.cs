...
namespace EDP.PGA.BO.PresentacionWeb.Utilities
{
    public static class Constantes
    {
        ...
        {
            public static class PagoPublicacion
            {
                public const string Codigos_Publicacion = "49751EF9-743A-4107-8FB3-DBC985DB0E2D";
                public const string Lista_PublicacionPorPagar = "B757C399-B928-40AF-9D26-E61504B6E0A0";
                public const string Lista_PublicacionFecha = "B757C309-B928-40AF-1D26-E61504B6E0A0";
                public const string codigoValidacion = "B757C309-B928-40AF-1226-E91594B9E0A0";
            }
            public static class Usuario
            {
                ...
                public const string TipoUsuario = "1a2d549bee0e-ad89-c479-4cc3-2007b3d3";
                public const string Direccion = "1a2d549bee0e-ad89-k2l4-4cc3-2007b3d3";
                public const string NroDocumento = "1a2d549bee0e-a9s0-c479-4cc3-2007b3d3";
                public const string TipoDocumento = "1a2d549bee0e-a9s0-c479-4cc3-d9dsb3d3";
                public const string Perfil = "132d549bee0e-a9s0-c479-4cc3-d9dsb3d3";
            }

            public static class LineaCredito
            {
                public const string Credito = "c5812d75-1325-45dc-815b-ddc3319c9497";
                public const string Disponible = "c5812d75-0983-45dc-815b-ddc3319c9497";
                public const string DiasVencido = "c5812d75-9823-45dc-815b-ddc3319c9497";
            }
            ...
            public static class Empresa
            {
                ...
                public const string Direccion = "764u7d92-70fe-446a-a09c-938eae85p2k3";
                //public const string Lista_Empresa = "a54u7d92-70fe-446a-a09c-938eae85d7a3";
            }

            public static class EmpresaUsuario
            {
                public const string CodigoEmpresa = "321b963e-9906-422c-917d-9436fe61147b";
                public const string DescripcionEmpresa = "098900a7-8529-46c2-8702-b3b6533affae";
            }
            public static class PuntoVentaUsuario
            {
                public const string CodigoPuntoVenta = "321b963e-9906-422c-917d-9436fe61sdfw";
                public const string DescripcionPuntoVenta = "098900a7-8529-46c2-8702-b3b6533rtyee";
            }
        ...
        public static class SolicitudLineaCredito
        {
            public static class Estado
            {
                ...
                public const string AprobadoNombre = "Aprobado";
                public const string RechazadoNombre = "Rechazado";
            }
            public static class Insert
            {
                public const int Tipo1 = 1;
                public const int Tipo2 = 2;
            }
        }
